                               ...
                               @if($surveyAttributesCount)
                                    @foreach($survey->surveyAttributes as $surveyAttribute)
                                        @if($surveyAttribute->label_type == 'checkbox')
                                            @include('Survey::partials.checkbox', ['attribute' => $surveyAttribute])
                                        @elseif($surveyAttribute->label_type == 'text_field')
                                            @include('Survey::partials.textfield', ['attribute' => $surveyAttribute])
                                        @elseif($surveyAttribute->label_type == 'radio_button')
                                            @include('Survey::partials.radiobutton', ['attribute' => $surveyAttribute])
                                        @elseif($surveyAttribute->label_type == 'text_area')
                                            @include('Survey::partials.textarea', ['attribute' => $surveyAttribute])
                                        @elseif($surveyAttribute->label_type == 'dropdown')
                                            @include('Survey::partials.dropdown', ['attribute' => $surveyAttribute])
                                        @endif
                                    @endforeach
                               @endif
